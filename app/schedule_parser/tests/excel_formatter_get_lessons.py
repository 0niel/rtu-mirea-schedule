...
class ExcelFormatterGetLessonsTests(unittest.TestCase):
    ...
    def test_get_lessons_2(self):
        ...
        correct_result = [
            {'name': 'Цифровые системы управления', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_3(self):
        ...
        correct_result = [
            {'name': 'Вычислительные системы реального времени', 'type': None}]
        self.assertEqual(result, correct_result)

    def test_get_lessons_4(self):
        result = self.formatter.get_lessons(
            '2,6,10,14 н Экология\n4,8,12,16 Правоведение')
        correct_result = [{'name': 'Экология', 'type': None}, {
            'name': 'Правоведение', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_7(self):
        ...
        correct_result = [{'name': 'Физика', 'type': None}, {
            'name': 'Организация ЭВМ и Систем', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_10(self):
        ...
        correct_result = [
            {'name': 'Основы научно-технического творчества', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_14(self):
        ...
        correct_result = [
            {'name': 'Техническая защита информации', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_22(self):
        ...
        correct_result = [
            {'name': 'Суд присяжных в России и зарубежных странах', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_23(self):
        ...
        correct_result = [
            {'name': 'Технологии развития имиджа территории', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_26(self):
        ...
        correct_result = [
            {'name': 'Физика (1 п/г)', 'type': None}, {'name': 'Физика (2 п/г)', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_39(self):
        ...
        correct_result = [
            {'name': '2гр. Безопасность систем баз данных', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_42(self):
        ...
        correct_result = [{'name': 'Разработка и эксплуатация защищенных автоматизированных систем 1 груп', 'type': None},
                          {'name': 'Разработка и эксплуатация защищенных автоматизированных систем 2 груп', 'type': None},
                          {'name': 'Инфраструктура открытых ключей в СЗИ 1 груп',
                              'type': None},
    ...
    def test_get_lessons_43(self):
        ...
        correct_result = [
            {'name': 'Разработка конфигураций в среде "1С: Предприятие"', 'type': None}]
        self.assertEqual(result, correct_result)
    ...
    def test_get_lessons_45(self):
        ...
        correct_result = [
            {'name': 'История (история России, всеобщая история)', 'type': None}]
        self.assertEqual(result, correct_result)

    def test_get_lessons_46(self):
        result = self.formatter.get_lessons(
        ...
        correct_result = [{'name': 'Введение в профессиональную деятельность', 'type': None}, {'name': 'Введение в профессиональную деятельность', 'type': None}, {
            'name': 'Введение в профессиональную деятельность', 'type': None}, {'name': 'Введение в профессиональную деятельность', 'type': None}]
        self.assertEqual(result, correct_result)
